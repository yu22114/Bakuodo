  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 200, background: "rgba(0,0,0,0.4)", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }} onClick={onCancel}>
      <div onClick={e => e.stopPropagation()} style={{ background: "#FFFFFF", borderRadius: "12px", padding: "28px 24px", maxWidth: "300px", width: "100%", boxShadow: "0 8px 32px rgba(0,0,0,0.15)" }}>
        ...
        <p style={{ margin: "0 0 24px", fontSize: "12px", color: "#111111", fontFamily: "'Noto Sans JP',sans-serif", lineHeight: 1.7 }}>参加をキャンセルします。<br />本当によろしいですか？</p>
        <div style={{ display: "flex", gap: "10px" }}>
          <button onClick={onCancel} style={{ flex: 1, padding: "11px", border: "1px solid rgba(0,0,0,0.15)", borderRadius: "6px", background: "transparent", color: "#111111", fontSize: "12px", fontFamily: "'Noto Sans JP',sans-serif", cursor: "pointer" }}>戻る</button>
