    ...
    <div style={{ height: "100dvh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div className="bd-scroll bd-glow-bg" style={{ flex: 1, overflowY: "auto", WebkitOverflowScrolling: "touch" as any, background: TAB_BG[tab], transition: "background 0.2s", padding: "20px 16px", display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        {tab === "cypher" ? (<>
          ...
          <button onClick={handleSubmit} disabled={loading} className={canPost ? "bd-spray" : undefined} style={{ width: "100%", padding: "20px 14px", border: "none", borderRadius: "6px", background: canPost ? "linear-gradient(135deg, #DC2626, #A61B1B)" : "rgba(255,255,255,0.08)", color: canPost ? "#fff" : "rgba(255,255,255,0.3)", fontSize: "15px", fontFamily: "'Noto Sans JP',sans-serif", fontWeight: 700, letterSpacing: "0.15em", cursor: canPost ? "pointer" : "not-allowed", opacity: loading ? 0.6 : 1 }}>
          ...
          <button onClick={handleSubmitPL} disabled={loading} className={canPostPL ? "bd-spray" : undefined} style={{ width: "100%", padding: "20px 14px", border: "none", borderRadius: "6px", background: canPostPL ? plAccentGradient : "rgba(255,255,255,0.08)", color: canPostPL ? onPlAccent : "rgba(255,255,255,0.3)", fontSize: "15px", fontFamily: "'Noto Sans JP',sans-serif", fontWeight: 700, letterSpacing: "0.15em", cursor: canPostPL ? "pointer" : "not-allowed", opacity: loading ? 0.6 : 1 }}>
